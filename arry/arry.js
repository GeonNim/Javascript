...
const arrA = [1, 2, 3, 4, 5, true, () => {}, {}, null];
console.log(arrA);
...
// split : 특정 문자열을 기준으로 나누어 배열을 리턴한다.
...
console.log(newUrl.indexOf('20'));
const a = newUrl.indexOf(1); //인덱스 번호 혹은 값을 넣어도 된다.
newUrl.splice(a, 1);
console.log(newUrl);
